              ...
              >
                <div className="glass-card bg-[#0f172a]/50 overflow-hidden group-hover:bg-white/[0.05] transition-all">
                   <div className="h-48 relative overflow-hidden">
                      <img src={result.thumbnail ? `https://wsrv.nl/?url=${encodeURIComponent(result.thumbnail)}&w=400&output=webp` : 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&q=80&w=400'} referrerPolicy="no-referrer" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" alt="" />
